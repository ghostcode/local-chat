<template>
  <div class="max-w-[1000px] mx-auto h-screen flex flex-col">
    ...
    <div
      id="emojiPanel"
      class="fixed z-[90] bg-white rounded-2xl shadow-xl border border-pink-100 p-4 w-[320px] max-h-[260px] overflow-y-auto"
    ...
    >
      <div id="emojiGrid" class="grid grid-cols-8 gap-1.5">
        <span
          ...
          :key="emoji"
          class="emoji-item cursor-pointer text-xl leading-[1] p-1.5 rounded-lg hover:bg-surface-hover transition-colors duration-150 select-none"
